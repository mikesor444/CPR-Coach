      ...
      <div className="fixed bottom-0 left-0 right-0 z-20 bg-white/95 shadow-[0_-4px_12px_rgba(0,0,0,0.08)] backdrop-blur lg:hidden">
        <div className="mx-auto flex max-w-4xl items-center gap-3 px-4 py-3">
          <button
            ...
            className="flex-1 rounded-xl border border-slate-200 px-3 py-3 text-center text-sm font-semibold text-slate-800 disabled:opacity-50"
          >
            Anterior
          </button>
          <button
            onClick={reset}
            className="flex-1 rounded-xl border border-amber-300 bg-amber-50 px-3 py-3 text-center text-sm font-semibold text-amber-800"
          >
            Reiniciar
          </button>
          <button
