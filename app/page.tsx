...
export default function HomePage() {
  return (
    <div className="min-h-screen">
      <header className="bg-gradient-to-r from-emerald-600 to-sky-600 px-4 py-8 text-white shadow-lg sm:px-6">
        <div className="mx-auto flex w-full max-w-5xl flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <h1 className="text-3xl font-black leading-tight lg:text-4xl">Soporte Vital Básico interactivo</h1>
            <p className="mt-2 max-w-3xl text-base text-emerald-50 sm:text-lg">
